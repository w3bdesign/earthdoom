      ...
      <div className="mt-4 flex w-full flex-col items-center justify-center gap-12 px-4 py-4 text-white">
        <div className="flex flex-col items-center gap-2 text-center text-lg">
          ...
          {isLoading ? (
            ...
            <div
              className="mb-4 rounded-lg bg-white  px-6 py-5 text-base text-red-700 md:min-w-[500px]"
              role="alert"
            >
          ...
          {friendliesData?.defenders && (
            <div
              className="mb-4 rounded-lg bg-white px-6 py-5 text-base text-green-700 md:min-w-[500px]"
              role="alert"
            >
