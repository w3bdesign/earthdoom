...
export const DataTable: React.FC<DataTableProps> = ({
  ...
  return (
    <table className="mt-4 w-[330px] md:w-full text-left ring-1 ring-slate-400/10">
      ...
      <tbody>
        {data.map((row, rowIndex) => (
          <tr
            key={rowIndex}
            className="block border-b bg-white last:border-b-0 sm:table-row sm:border-none p-4 md:p-0"
          >
