...
const CombatReport: React.FC<CombatReportProps> = ({
  ...
  return (
    <table className="py-6 text-left ring-1 ring-slate-400/10 md:w-full">
      <caption className="py-4 text-center text-xl font-bold text-black bg-slate-400/90">
        {title} - {time}
      </caption>
      <thead>
      ...
      <tbody>
        <tr className="block border-b p-4 last:border-b-0 sm:table-row sm:border-none md:p-0">
          <td className="flex h-12 items-center px-6 text-center bg-slate-300/90 text-base font-bold text-black transition duration-300 before:inline-block before:w-24 before:font-medium before:text-black before:content-[attr(data-th)':'] first:border-l-0  sm:table-cell sm:border-l sm:border-t sm:before:content-none">
            Defenders
          </td>
