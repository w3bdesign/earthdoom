...
describe("Navbar component", () => {
  ...
  it("links have correct href attributes", () => {
    ...
    expect(screen.getByText("Manual").closest("a")).toHaveAttribute(
      "href",
      "https://earthdoom.com/manual",
    );
  ...
  it("useClickAway callback collapses the menu", () => {
    ...
    const clickAwayCallback = mockUseClickAway.mock.calls[0]?.[1] as
      | (() => void)
      | undefined;
    act(() => {
