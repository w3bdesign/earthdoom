...
describe('RankingActions', () => {
  ...
  it('navigates to military attack page when attack button is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/military?target=OtherPlayer&action=attack');
  });
  ...
  it('navigates to military defend page when defend button is clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/military?target=OtherPlayer&action=defend');
  });
  ...
  it('shows tooltip text in span elements', () => {
    ...
    expect(screen.getByText('Send your troops to attack this player')).toBeInTheDocument();
    expect(screen.getByText('Send your troops to defend this player')).toBeInTheDocument();
  });
