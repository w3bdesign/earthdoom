...
describe('DataTable', () => {
  ...
  it('renders the caption', () => {
    ...
    render(
      <DataTable columns={defaultColumns} data={[player]} caption="Test Caption" />
    );
  ...
  it('renders player data values in cells', () => {
    const player = createMockPaPlayer({ crystal: 9999, metal: 4444, energy: 2222 });
    render(
      <DataTable columns={defaultColumns} data={[player]} caption="Resources" />
    );
  ...
  it('renders a table element with correct structure', () => {
    ...
    const { container } = render(
      <DataTable columns={defaultColumns} data={[player]} caption="Structure" />
    );
  ...
  it('renders data-th attributes on td elements for responsive labels', () => {
    const player = createMockPaPlayer();
    const { container } = render(
      <DataTable columns={defaultColumns} data={[player]} caption="Responsive" />
    );
